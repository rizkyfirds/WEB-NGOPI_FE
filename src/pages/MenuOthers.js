...
function MenuCoffee() {
    ...
    useEffect(() => {
        axios({
            method: "GET",
            url: "http://localhost:3000/product/others"
        }).then((result) => {
            ...
            <div className="h-8/13">
                <div className="h-1/10">
                    <div className="flex">
                        ...
                        <button className="w-1/4 text-center text-xs text-white text-bold" onClick={() => snack()}>Snack</button>
                        <button className="w-1/4 text-center text-xs text-white text-bold" onClick={() => course()}>Main Course</button>
                        <p className="w-1/4 text-center text-xs text-[#FF8A00] text-bold">Others</p>
                    </div>
                </div>
